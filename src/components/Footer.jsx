    ...
    <footer className="bg-background py-12 border-t border-border-subtle">
      <div className="container-custom">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            <h3 className="text-xl font-bold mb-4 text-foreground">{footerCopy.brand}</h3>
            <p className="text-muted mb-4">
              {footerCopy.description}
            </p>
            <div className="flex space-x-4">
              <a href="https://github.com/rekaali" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-foreground transition-colors">
              ...
              <a href="https://linkedin.com/in/muhdalizulfaqar" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-foreground transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          >
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-muted mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-muted">muhdalizulfaqar@gmail.com</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-muted mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-muted">Available via email</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-muted mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-muted">Malaysia</span>
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        <motion.div 
          className="border-t border-border-subtle mt-12 pt-8 text-center text-muted"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, delay: 0.3 }}
        >
          <p>&copy; {currentYear} {footerCopy.brand}. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
